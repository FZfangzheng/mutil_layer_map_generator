...
def make_seg_img_from_maps(maps_path,segs_new_path,cache_path,one_time_num=500):
    ...
    allmap=None
    stand_rgb = [[233, 228, 222], [243, 240, 233], [251, 253, 252], [252, 157, 39], [252, 223, 147],[203,223,172],[177,208,254],[200,199,197]]
    for a in tqdm(range(N_file)):
        allmap=None
    ...
    print('start k-means')
    t1 = time.time()
    Z,  k = k_mean_fromfile(cache_path, 8, stand_rgb,N_file=N_file)
    t2 = time.time()
    ...
    for a in range(N_file):
        ...
        for i in range(one_time_num):
            ...
            new_im = gray2rgb(ret_new,n_class=8, label_list=[[233, 228, 222], [243, 240, 233], [251, 253, 252], [252, 157, 39], [252, 223, 147],[203,223,172],[177,208,254],[200,199,197]])
