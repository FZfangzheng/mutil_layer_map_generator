...
def prepare_for_train_dataloader(dataroot, bs_train = 4, shuffle = True, num_workers = 0, check_dataloader = False):
    """
...
def prepare_for_val_dataloader(dataroot, bs_val = 4, shuffle = False, num_workers = 0):
    """
    use pascal 2012
    """
